...
@RestController
@RequestMapping("/api/myblog-kafka")
public class MyblogKafkaResource {

    private final Logger log = LoggerFactory.getLogger(MyblogKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public MyblogKafkaResource(KafkaProperties kafkaProperties) {
